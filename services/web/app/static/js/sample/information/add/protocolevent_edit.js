...
function check_protocol_type() {
    ...
    const intact_types = ["Sample Transfer", "Collection", "Study", "Temporary Storage", "Sample Aliquot / Derivation"];
    // Reduction in quantity for Sample derivative/aliquot can't be edited
    ...
    if (matches) {
        ...
        if (intact_types.includes(protocol_type))
            ...
            if (reduced_qty_old == null || reduced_qty_old == '')
                $("#sample-quantity").hide();
            else
...
var reduced_qty_old = $("#reduced_quantity").val();
$(document).ready(function() {
    ...
    $("#reduced_quantity").change(function () {
        ...
        $("#remaining_quantity").val(remaining_qty + reduced_qty_old - reduced_qty);
    });
